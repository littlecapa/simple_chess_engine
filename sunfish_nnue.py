...
import pdb
import time
from libs.eval import Eval as e

evaluator = e()

#nnue = cdll.LoadLibrary("./eval_lib/libnnueprobe.so")

#nnue.nnue_init(b"./eval_lib/nn-04cf2b4ed1da.nnue")
...
class Position(namedtuple('Position', 'board score wc bc ep kp')):
    ...
    def value(self, move):
        ...
        if "K" in end_board and "k" in end_board and (hce_score < MATE_LOWER and hce_score > -MATE_LOWER):
            ...
            start_score = evaluator.get_score(start_fen)/2.08
            end_score = evaluator.get_score(end_fen)/2.08
